      ...
      <main className="flex-1 w-full pb-24 px-6 overflow-x-hidden">
        ...
        <div className="pt-40 pb-10 text-center max-w-5xl mx-auto animate-fadeIn relative">
          ...
          <h1 className="relative z-10 mb-2 text-4xl md:text-5xl font-heading uppercase tracking-wide">
            {isEs ? "Bienvenido a tu plan," : "Welcome to your blueprint,"} <span className="text-mm-gold">{(sessionPayload?.name || (typeof window !== 'undefined' ? localStorage.getItem('mm_user_name') : null) || (isEs ? "Atleta" : "Athlete")).toUpperCase()}</span>
          </h1>
